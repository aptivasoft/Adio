...
<body>
    ...
    <table align="center" width="100%">
        <tr class="medication_info_th1">
              ...
              <asp:Label ID="lblHeading" runat="server" Text="Insurance List"></asp:Label>
              </td>                   
        </tr>
            ...
            <asp:GridView ID="GVList" runat="server" Width="100%" 
                    ...
                    AllowPaging = "true" onpageindexchanging="GVList_PageIndexChanging" PageSize="25" >
                       ...
                       <Columns>
                           ...
                           <asp:BoundField HeaderText="Insurance Number" DataField = "InsNumber">
                           ...
                           <asp:BoundField HeaderText="Address" DataField = "InsAddress">
