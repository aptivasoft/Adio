<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivityCodesList.aspx.cs" Inherits="Patient_ActivityCodesList" %>
...
<body>
    ...
    <table align="center" width="100%">
        <tr class="medication_info_th1">
              ...
              <asp:Label ID="lblHeading" runat="server" Text="Activity Codes"></asp:Label>
              </td>                   
        </tr>
        ...
        <tr class="medication_info_tr-even">
            ...
            <asp:GridView ID="GVList" runat="server" Width="100%" 
                    ...
                    AllowPaging = "true" onpageindexchanging="GVList_PageIndexChanging" PageSize="25" >
                       ...
                       <Columns>
                           <asp:BoundField HeaderText="Activity Code" DataField = "Activity_Code" ItemStyle-HorizontalAlign="Left">
                               
                           </asp:BoundField>
                           <asp:BoundField HeaderText="Activity Name" DataField = "Activity_Name" ItemStyle-HorizontalAlign="Left">
                               
                           </asp:BoundField>  
                           <asp:BoundField HeaderText="Activity Description" DataField = "Activity_Description" ItemStyle-HorizontalAlign="Left">
