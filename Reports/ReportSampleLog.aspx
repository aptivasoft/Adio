<%@ Page Language="C#" MasterPageFile="~/Templates/eCareXMaster.master" AutoEventWireup="true" CodeFile="ReportSampleLog.aspx.cs" Inherits="ReportSampleLog" Title="eCarex Health Care System" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table  align="center"  width="1000px" class="patient_info">
        <tr class="medication_info_th1">
            ...
            <asp:Label ID = "lblSType" runat = "server" Text = "Type :"></asp:Label><br />
                <asp:DropDownList ID="ddlSType" runat="server" style="width:125px">
...
</cc1:CalendarExtender></td>    <td align="left" style="width:130px" >
...
<cc1:CalendarExtender ID="CalendarExtender2" runat="server" PopupPosition="Right" PopupButtonID="Image2"
    TargetControlID="txtDate2">
            ...
            Font-Names="Verdana" Font-Size="8pt" Height="380px" Width="1000px" 
                    ZoomMode="PageWidth" ondrillthrough="ReportViewer2_Drillthrough">
          
            
          <LocalReport ReportPath="Reports\RptSLog.rdlc" EnableHyperlinks="True">
         <DataSources>
             <rsweb:ReportDataSource DataSourceId="SqlDataSource1" Name="DataSet4_sp_ReportDrugActivity" />
         </DataSources>
    </LocalReport>
    <LocalReport ReportPath="Reports\RptSInventLog.rdlc">
         <DataSources>
             <rsweb:ReportDataSource DataSourceId="SqlDataSource1" Name="dsDInventLog_sp_ReportDrugActivityLog" />
         </DataSources>
    </LocalReport>
         </rsweb:ReportViewer>
                 </td>
