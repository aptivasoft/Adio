<%@ Page Language="C#" MasterPageFile="~/Templates/eCareXMaster.master" AutoEventWireup="true" CodeFile="ReportTimesheet.aspx.cs" Inherits="ReportTimesheet" Title="eCarex Health Care System" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table  align="center"  width="1000px" class="patient_info">
        <tr class="medication_info_th1">
            ...
            <td align="left" style="width:950px" colspan="2"  >
            &nbsp;&nbsp;<asp:Label ID="lblPP" runat="server" Text="Pay Period :"></asp:Label>&nbsp;&nbsp;<asp:DropDownList
                    ID="ddlPP" runat="server" OnDataBound="ddlPP_DataBound" 
                    ></asp:DropDownList>
