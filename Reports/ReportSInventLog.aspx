<%@ Page Language="C#" MasterPageFile="~/Templates/eCareXMaster.master" AutoEventWireup="true" CodeFile="ReportSInventLog.aspx.cs" Inherits="ReportSInventLog" Title="eCarex Health Care System" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table  align="center"  width="1000px" class="patient_info">
        <tr class="medication_info_th1">
            ...
            <td align="left" style="width:125px" >
            <asp:Label ID = "lblDrugId" runat = "server" Text = "Drug ID :"></asp:Label><br />
                <asp:TextBox ID="txtDrugID" runat="server" style="width:125px">
...
--%>            <tr class="medication_info_tr-odd">
          ...
          <LocalReport ReportPath="Reports\RptSLog.rdlc">
         <DataSources>
