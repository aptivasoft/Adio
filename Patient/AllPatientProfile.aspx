...
<asp:TextBox ID="txtPatientName1" runat="server" Width="230px"></asp:TextBox>
    ...
    <a href="PatientProfile.aspx" ><img src="../images/add_male_user.png" height="24px" width="24px" alt="Add New Patient" style="border:0px" /></a>
...
<cc1:ModalPopupExtender ID="MPE_SamplePAPProcessing" 
                        ...
                        Enabled="True" DynamicServicePath=""></cc1:ModalPopupExtender>
...
<ItemTemplate>
  ...
  <asp:Image ID="imgEditRx" runat="server" ImageUrl="../Images/edit.gif" ToolTip="Edit"/></asp:LinkButton>
</ItemTemplate>
...
<asp:TemplateField><ItemTemplate>
                  <asp:LinkButton ID="lnkDeleteDrug" runat="server" CausesValidation="False" CommandName="Delete"   OnClientClick="if(!confirm('Do you want to delete the Rx?')){ return false;}"><asp:Image ID="imgDeleteRx" runat="server" ImageUrl="../Images/delete.gif" ToolTip="Delete"/></asp:LinkButton> 
...
<asp:TemplateField ><ItemTemplate>
<asp:LinkButton ID="lnkProcess" runat="server" CommandName="Processing" CommandArgument='<%# Eval("Rx_ItemID")%>' Visible='<%# display_link1((string) Eval("RXTypeDesc"),(string) Eval("RXStatusDesc"))%>'  Font-Bold="false"><asp:Image ID="imgProcess" runat="server" ImageUrl="../Images/process.png" Height="24px" Width="24px" ToolTip ="Process"/></asp:LinkButton>
</ItemTemplate>
...
<br /><asp:LinkButton ID="btnAddPresc" ForeColor="#000066"  Enabled="False" 
...
<asp:Panel ID="pnlAddPrescription" runat="server" BorderColor="Black" BorderWidth="1px"  BackColor="#FBFBFB" >
                                 ...
                                 ServiceMethod="GetDoctorNames"  CompletionListCssClass="AutoExtender2" DelimiterCharacters="" 
                                                                 ServicePath="" ></cc1:AutoCompleteExtender>
...
<cc1:AutoCompleteExtender ID="autoFillSIG" BehaviorID="acCustodianEx23" TargetControlID ="txt_P_sig" UseContextKey="True" runat="server"  
                                 ...
                                 ServiceMethod="GetSIGNames"   CompletionListCssClass="AutoExtender2" DelimiterCharacters="" ServicePath=""></cc1:AutoCompleteExtender>
...
<cc1:AutoCompleteExtender ID="AutoCompleteSigCodes2" TargetControlID="txt_P_sig" 
                          ...
                          <table width="425px"   border="0" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                  ...
                                  <asp:TextBox ID="txtDocName" runat="server" Width="150px"></asp:TextBox></td></tr>
                                  <tr ><td align="left" colspan="2"><asp:Label ID = "lblPharm" Text = "Pharmacy :" runat = "server"  Font-Bold="True"></asp:Label></td>
                                        <td colspan="2" align="left"><asp:RadioButton ID="rbtnAdioPharmacy" Text="Adio"  GroupName="PPharmacy" 
                                  ...
                                  <asp:RadioButton ID="rbtnOtherPharmacy" Text="other" GroupName="PPharmacy" runat="server"/><br />
                                      <asp:TextBox ID="txtPharmacy" runat="server" style="visibility:hidden"  Width="150px"></asp:TextBox>
                                         ...
                                         <tr ><td align="left" colspan="2"><asp:Label ID = "lbl_P_Med" Text = "Medication Name :" runat = "server"  
                                          Font-Bold="True"></asp:Label></td>
                                          <td colspan="2" align="left"><asp:TextBox ID="txt_P_Med" runat="server" Width="150px"></asp:TextBox></td>
                                          </tr>
                                        <tr><td align="left" colspan="2" ><asp:Label ID = "lbl_P_Qty" Text = "Quantity :" runat = "server" Font-Bold="True"></asp:Label></td>
                                            <td align="left" height="25px"  colspan="2"><asp:TextBox ID="txt_P_Qty"  runat="server" Width="50px"></asp:TextBox>
                                        ...
                                        <tr><td  align="left" colspan="2"><asp:Label ID = "lbl_P_sig" Text = "SIG :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="left" height="25px" colspan="2"><asp:TextBox ID="txt_P_sig" runat="server" Width="150px"></asp:TextBox></td></tr><tr><td align="left" colspan="2"><asp:Label ID = "lbl_P_Refills" Text = "Refills :" runat = "server"  
                                          Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:DropDownList ID="ddl_P_Refills" runat="server" Width="155px">
                                                ...
                                                </asp:DropDownList></td></tr><tr><td align="left" ><asp:Label ID = "lbl_P_Status" Text = "Status :" runat = "server"  
                                          Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:DropDownList ID="ddl_P_Status" runat="server" Width="155px" 
                                          DataSource="<%# RxStatus.getRxStatus(1) %>"  DataTextField="Status_Desc" 
                                          DataValueField="Status_Code"></asp:DropDownList></td></tr><tr><td align="left" colspan="2" ><asp:Label ID = "lblTypeRx" Text = "Type :" runat = "server"  
                                          Font-Bold="True"></asp:Label></td><td align="left" colspan="3"><asp:RadioButton ID="rbtnRegular" Text="Regular" GroupName="RX_Type" runat="server" />
                                                             &nbsp;&nbsp;<asp:RadioButton ID="rbtnPAP" Text="PAP" GroupName="RX_Type" runat="server" />
                                                             &nbsp; <asp:RadioButton ID="rbtnSample" Text="Sample" GroupName="RX_Type" runat="server" /></td></tr><tr><td align="left" colspan="2"><asp:Label ID = "lblRxComments" Text = "Comments :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:TextBox ID="txtRxComments" runat="server" TextMode="MultiLine" Width="150px"></asp:TextBox></td></tr>
                                  <tr><td  colspan="2">
                                  ...
                                  <tr><td  align="center" colspan="4"><asp:HiddenField ID="hidRXID" runat="server" /><asp:HiddenField ID="HiddenField1" runat="server" /><asp:HiddenField ID="HiddenField2" runat="server" /></td></tr></table></td>
                              </tr>
                          </table>
                          </asp:Panel>
...
<cc1:AutoCompleteExtender ID="AutoCompleteExtender5"
 ...
 <table width="375px"   border="0" cellpadding="0" cellspacing="0">
                              <tr class="medication_info_th1" width="100%">
                                  <td colspan="2"  height="30px"  align="left">
                                                     &nbsp;&nbsp;Prescription Details [ EDIT MODE ]</td>
                                                     <td align="right"><asp:ImageButton ID="imgBtnEditClose" runat="server"  ImageUrl="../images/close_popup.png" Height="16px" Width="16px" border="0" ToolTip="Close"></asp:ImageButton>
                                  ...
                                  <td width="375px" colspan="3" align="center">
                                      ...
                                      <tr >
                                      <td align="left" colspan="2"  ><asp:Label ID = "Label7" Text = "Doctor Name :" runat = "server"  Font-Bold="True"></asp:Label>
                                      </td>
                                      <td colspan="2"  >
...
<asp:HiddenField ID="hfRXItemID" runat="server" />
                                  ...
                                  <asp:Panel ID="pnlDiscontinue" runat="server" BorderColor="Black" BorderWidth="1px"  BackColor="#FBFBFB" >
	                                ...
	                                <td align="right"><asp:ImageButton ID="btnDCCancel" runat="server"  ImageUrl="../images/close_popup.png" Width="16px" Height="16px" border="0"></asp:ImageButton>
...
<cc1:ModalPopupExtender ID="AddMedcation" runat="server" 
                            ...
                            DynamicServicePath="" Enabled="True" ></cc1:ModalPopupExtender>
                       ...
                       Width="99%" ScrollBars="Vertical">
                            ...
                            <asp:BoundField HeaderText="RxDate" DataField="RxDate" DataFormatString="{0:MM/dd/yyyy}" >
                                <ItemStyle HorizontalAlign="Center" Width="200px" /></asp:BoundField><asp:TemplateField HeaderText="Medicine"><ItemTemplate><asp:Label ID="lblMedicine" runat="server" Text= '<%# Eval("Medicine")%>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField><asp:TemplateField HeaderText="Quantity"><ItemTemplate><asp:Label ID="lblQty" runat="server" Text= '<%# Eval("Qty")%>'></asp:Label></ItemTemplate><EditItemTemplate><asp:TextBox ID="txtQty" runat="server" Text= '<%# Eval("Qty")%>' ></asp:TextBox></EditItemTemplate><ItemStyle HorizontalAlign="Right" /></asp:TemplateField><asp:TemplateField HeaderText="Direction"><ItemTemplate><asp:Label ID="lblSIG" runat="server" Text= '<%# Eval("SIG")%>'></asp:Label></ItemTemplate><EditItemTemplate><asp:TextBox ID="txtSIG" runat="server" Text= '<%# Eval("SIG")%>'></asp:TextBox></EditItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField><asp:TemplateField HeaderText="Refills"><ItemTemplate><asp:Label ID="lblRefills" runat="server" Text= '<%# Eval("Refills")%>'></asp:Label></ItemTemplate><EditItemTemplate><asp:DropDownList ID="ddlRefills" runat="server"><asp:ListItem Text="0" Value="0">                                
                                    </asp:ListItem><asp:ListItem Text="1" Value="1">                                
                                    </asp:ListItem><asp:ListItem Text="2" Value="2">                                
                                    </asp:ListItem><asp:ListItem Text="3" Value="3">                                
                                    </asp:ListItem><asp:ListItem Text="4" Value="4">                                
                                    </asp:ListItem><asp:ListItem Text="5" Value="5">                                
                                    </asp:ListItem>
                                                 </asp:DropDownList></EditItemTemplate><ItemStyle HorizontalAlign="Center" /></asp:TemplateField><asp:TemplateField HeaderText="Doctor" ><ItemTemplate><asp:Label ID="lblDocName" runat="server" Text= '<%# Eval("Doc_FullName")%>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField></Columns>
                                                 <HeaderStyle CssClass="medication_info_th3" />
                                                 <RowStyle CssClass="medication_info_tr-odd" />
                                                 </asp:GridView>
                                                 </asp:Panel>

                                                 <br /><asp:LinkButton ID="btnAddMed1" ForeColor="#000066" runat="server" OnClientClick="return clearMedicationPanel();" Style="visibility:hidden" >Add Medication</asp:LinkButton><asp:Panel ID="pnlAddMedication" runat="server" BorderColor="Black" BorderWidth="1px"  BackColor="#FBFBFB" ><cc1:AutoCompleteExtender ID="AutoCompleteExtender1" 
                                 BehaviorID="acCustodianEx1" TargetControlID ="txtDoc" UseContextKey="True" 
                                 runat="server"  MinimumPrefixLength="1"  Enabled="True"  
                                 ServiceMethod="GetDoctorNames"  CompletionListCssClass="AutoExtender2"></cc1:AutoCompleteExtender><cc1:AutoCompleteExtender ID="AutoCompleteExtender2" 
                                 BehaviorID="acCustodianEx2" TargetControlID ="txtMedicationName" 
                                 UseContextKey="True" runat="server"  MinimumPrefixLength="1"  Enabled="True"  
                                 ServiceMethod="GetMedicationNames"  CompletionListCssClass="AutoExtender2"></cc1:AutoCompleteExtender><cc1:AutoCompleteExtender ID="AutoCompleteSigCodes1" 
                                 ...
                                 runat="server"></cc1:AutoCompleteExtender><table width="350"   border="0" cellpadding="0" cellspacing="0"><tr class="medication_info_th1" width="100%"><td  height="30px" align="left">
                                                     &nbsp;&nbsp;Medication Details </td><td align="right"><asp:ImageButton ID="btnCancel" runat="server"  ImageUrl="../images/close_popup.png" Height="16px" Width="16px" border="0" ToolTip="Close"></asp:ImageButton>
                                                         &nbsp;</td></tr><tr><td width="350" colspan="2" align="center"><table align="center" class="medication_info_popup" cellpadding="0" cellspacing="1"><tr ><td align="left"><asp:Label ID = "Label12" Text = "Medication Name :" runat = "server" 
                                  Font-Bold="True" ></asp:Label></td><td><asp:TextBox ID="txtMedicationName" runat="server"></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "Label13" Text = "Quantity :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="left" height="25px"><asp:TextBox ID="txtQty" runat="server" Width="50px"></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "Label14" Text = "Direction :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="left" height="25px"><asp:TextBox ID="txtDirection"  runat="server" ></asp:TextBox></td></tr><tr><td  align="left" ><asp:Label ID = "Label15" Text = "Refills :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="left" height="25px"><asp:DropDownList ID="ddlPopupRefills" runat="server" >
                                    <asp:ListItem Text="0" Value="0"></asp:ListItem>
                                                <asp:ListItem Text="1" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="2" Value="2"></asp:ListItem>
                                                <asp:ListItem Text="3" Value="3"></asp:ListItem>
                                                ...
                                                <asp:ListItem Text="13" Value="13"></asp:ListItem>
                                                <asp:ListItem Text="14" Value="14"></asp:ListItem>
                                                <asp:ListItem Text="15" Value="15"></asp:ListItem>                                    </asp:DropDownList></td></tr><tr><td align="left" ><asp:Label ID = "Label17" Text = "Doctor :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="right"><asp:TextBox ID="txtDoc" runat="server"></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "Label1" Text = "RXDate :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="right"><asp:TextBox ID="txtRXDate" runat="server"></asp:TextBox><cc1:CalendarExtender ID="Getdate" runat="server" TargetControlID="txtRXDate" 
                                  PopupButtonID="txtRXDate" Enabled="True"></cc1:CalendarExtender></td></tr><tr><td  align="center" colspan="2"><asp:HiddenField ID="hfID" runat="server" /><asp:HiddenField ID="hfStatus" runat="server" /><asp:ImageButton ID="btnSave" runat="server"  ImageUrl="../images/save.gif" border="0" OnClick="btnSaveMed_Click" OnClientClick="return ValidatePatientMedication();"></asp:ImageButton></td></tr></table></td></tr></table></asp:Panel>
...
<ContentTemplate>
    ...
    <asp:ImageButton ID="ImageButton1" runat="server"  ImageUrl="~/images/delete.gif" OnClientClick="if(!confirm('Do you want to delete Allergy')){ return false;}" CommandName="Delete" CommandArgument='<%# Eval("PA_ID") %>'/>
                                         ...
                                         <ItemTemplate><asp:Label ID="lblPA_ID" runat="server" Text='<%#Eval("PA_ID")%>'></asp:Label>
                                         </ItemTemplate></asp:TemplateField>
                                         <asp:TemplateField HeaderText="S.No">
                                         <ItemTemplate><asp:Label ID="lblSno" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                         </ItemTemplate>
                                         <ItemStyle HorizontalAlign="Center" Width="50px" />
                                         </asp:TemplateField><asp:TemplateField HeaderText="Allergic To">
                                         <ItemTemplate><asp:Label ID="lblAllergic" runat="server" Text='<%# Eval("Pat_Allergic_To")%>'></asp:Label>                                
                                         </ItemTemplate>
                                         <EditItemTemplate><asp:TextBox ID="txtAlleryTO" runat="server" Text='<%# Eval("Pat_Allergic_To")%>'>
                                         </asp:TextBox>
                                         </EditItemTemplate>
                                         <ItemStyle HorizontalAlign="Left" />
                                         </asp:TemplateField><asp:TemplateField HeaderText="Allergic Condition">
                                         <ItemTemplate>
                                         ...
                                         </EditItemTemplate><ItemStyle HorizontalAlign="Left" />
                                         </asp:TemplateField>
                                         </Columns>
                                         <HeaderStyle CssClass="medication_info_th1" />
                                         <RowStyle CssClass="medication_info_tr-odd" />
                                         </asp:GridView>
                                         <asp:LinkButton ID="btnAddAllergy" runat="server" OnClientClick="return clearAllergyPanel();" ForeColor="#000066" >Add Allergy</asp:LinkButton><asp:Panel ID="pnlAddAllergy" runat="server" BorderColor="Black" BorderWidth="1px"  BackColor="#FBFBFB" ><table width="350"   border="0" cellpadding="0" cellspacing="0"><tr class="medication_info_th1" width="100%"><td colspan="2"  height="30px"  align="left">
            &nbsp;&nbsp;Allergy Details </td><td align="right"><asp:ImageButton ID="btnAClose" runat="server"  ImageUrl="../images/close_popup.png" Height="16px" Width="16px" border="0" ToolTip="Close"></asp:ImageButton>
                &nbsp;</td></tr><tr><td width="350" colspan="3" align="center"><table align="center" class="medication_info_popup" cellpadding="0" cellspacing="1"><tr ><td align="left"><asp:Label ID = "lblAllergyTo" Text = "Allergic To :" runat = "server"  Font-Bold="True"></asp:Label></td><td colspan="2"><asp:TextBox ID="txtAllergyTo" runat="server"></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "lblAllergyDesc" Text = "Allergy Description :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="right" height="25px" colspan="2"><asp:TextBox ID="txtAllergyDesc" runat="server" TextMode="MultiLine" Rows="5" Width="100%"></asp:TextBox></td></tr><tr><td  align="center" colspan="4"><asp:ImageButton ID="btnSaveAllergy" runat="server"  ImageUrl="../images/save.gif" border="0" OnClick="btnSaveAllergy_Click" OnClientClick="return ValidatePatientAllergy();"></asp:ImageButton></td></tr></table></td></tr></table></asp:Panel>
    </ContentTemplate>
    

</cc1:TabPanel>                
<cc1:TabPanel ID="Patient_Ins" runat="server" Height="85"><HeaderTemplate>
        Insurance
...
<cc1:ModalPopupExtender ID="MPEEditInsurance" runat="server" TargetControlID="btnEditIns" PopupControlID="pnlEditInsurance" CancelControlID="btnInsEditClose" BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></cc1:ModalPopupExtender>
    ...
    <asp:TemplateField   ShowHeader="False">
      ...
      <HeaderStyle CssClass="patient_cm_info_th1" /><ItemStyle HorizontalAlign="Center" /></asp:TemplateField>
      <asp:TemplateField>
        <ItemTemplate>
        ...
        <ItemStyle HorizontalAlign="Center" Width="20px" />
    </asp:TemplateField><asp:TemplateField HeaderText="S.No"><ItemTemplate>
    <asp:Label ID="lblSno" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Center" Width="50px" /></asp:TemplateField>
    <asp:TemplateField  Visible="False"> 
    <ItemTemplate>                                
    <asp:Label ID="lblpatInsID" runat="server" Text='<%# Eval("Patient_Ins_ID")%>'></asp:Label></ItemTemplate>
    ...
    <ItemStyle HorizontalAlign="Right" />
    </asp:TemplateField><asp:TemplateField HeaderText="BIN #">
 
     <ItemTemplate>                                
    <asp:Label ID="lblpatBINNo" runat="server" Text='<%# Eval("PI_BINNo")%>'></asp:Label></ItemTemplate>
    <ItemStyle HorizontalAlign="Right" /></asp:TemplateField>
    <asp:TemplateField HeaderText="GROUP NO">
   <ItemTemplate>                                
    <asp:Label ID="lblpatGRPNo" runat="server" Text='<%# Eval("PI_GroupNo")%>'></asp:Label></ItemTemplate>
    <ItemStyle HorizontalAlign="Right" /></asp:TemplateField>
    <asp:TemplateField HeaderText="Phone #">
   
     <ItemTemplate>                                
    <asp:Label ID="lblpatPhNo" runat="server" Text='<%# Eval("PI_Phone")%>'></asp:Label></ItemTemplate>
    </asp:TemplateField><asp:TemplateField HeaderText="Rel.To Insd">
     <ItemTemplate>                                
    <asp:Label ID="lblINSDRel" runat="server" Text='<%# Eval("PI_InsdRel")%>'></asp:Label></ItemTemplate>
    <ItemStyle HorizontalAlign="Left" /></asp:TemplateField>
    ...
    <AlternatingRowStyle CssClass="medication_info_tr-even" /><HeaderStyle CssClass="medication_info_th1" /><RowStyle CssClass="medication_info_tr-odd" /></asp:GridView><asp:LinkButton ID="btnAddIns" ForeColor="#000066"  runat="server" OnClientClick="return clearInsurancePanel();">Add Insurance</asp:LinkButton>
    <asp:Panel ID="pnlAddInsurance" runat="server" BorderColor="Black" BorderWidth="1px"  BackColor="#FBFBFB" >
        <cc1:AutoCompleteExtender ID="AutoCompleteExtender6" 
            ...
            DelimiterCharacters="" ServicePath=""></cc1:AutoCompleteExtender>
         <table width="350"   border="0" cellpadding="0" cellspacing="0">
         <tr class="medication_info_th1" width="100%">
         <td colspan="2"  height="30px"  align="left">
             &nbsp;&nbsp;Insurance Details </td><td align="right">
            <asp:ImageButton ID="btnIClose" runat="server"  ImageUrl="../images/close_popup.png" Height="16px" Width="16px" border="0" ToolTip="Close"></asp:ImageButton>
                 &nbsp;</td></tr><tr><td width="350" colspan="3" align="center">
                <table align="center" class="medication_info_popup" cellpadding="0" cellspacing="1">
                <tr >
                <td align="left"><asp:Label ID = "Label3" Text = "Insurance Name :" runat = "server"   Font-Bold="True"></asp:Label></td>
                <td colspan="2"><asp:TextBox ID="txtInsName" runat="server"></asp:TextBox></td></tr>
                <tr>
                <td>
                <asp:Label ID = "Label4" Text = "Insurance Phone :" runat = "server"  Font-Bold="True"></asp:Label>
                </td>
                <td colspan="2"><asp:TextBox ID="txtInsPhone" runat="server"></asp:TextBox></td></tr>
                <tr><td align="left" ><asp:Label ID = "lblPID" Text = "Policy ID :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:TextBox ID="txtPID" runat="server" ></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "lblGNo" Text = "Group No :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:TextBox ID="txtGNO" runat="server" ></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "lblBNO" Text = "BIN No :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:TextBox ID="txtBNO" runat="server" ></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "lblIName" Text = "Insured Name :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:TextBox ID="txtIName" runat="server" ></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "lblIDOB" Text = "Insured DOB :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:TextBox ID="txtIDOB" runat="server" ></asp:TextBox><cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtIDOB" 
                                  PopupButtonID="txtIDOB" Enabled="True"></cc1:CalendarExtender></td></tr><tr><td align="left" ><asp:Label ID = "lblISSN" Text = "Insured SSN :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:TextBox ID="txtISSN" runat="server" ></asp:TextBox></td></tr><tr><td align="left" ><asp:Label ID = "lblIRel" Text = "Insured Relation :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left" colspan="2"><asp:TextBox ID="txtIRel" runat="server" ></asp:TextBox></td></tr><tr><td align="left" colspan="3"><asp:Label ID="lblIsPrimary" runat = "server" Text = "Is Primary Insurance:" 
                                  Font-Bold="True" ></asp:Label><asp:CheckBox ID="chkIsPrimary" runat ="server"/></td></tr><tr><td align="left" colspan="3"><asp:RadioButton ID="rbtnIActive" Text="Active" GroupName="InsActive" runat="server" />
                        &nbsp;<asp:RadioButton ID="rbtnIinActive" Text="InActive" GroupName="InsActive" runat="server" /></td></tr><tr><td  align="center" colspan="4"><asp:ImageButton ID="btnSaveInsurance" runat="server"  ImageUrl="../images/save.gif" border="0" OnClick="btnSaveInsurance_Click" OnClientClick="return ValidatePatientInsurance();"></asp:ImageButton></td></tr></table></td></tr></table>
    </asp:Panel>
    ...
    <!-- Insurance Edit Mode -->
        ...
        <cc1:AutoCompleteExtender ID="AutoCompleteExtender7" 
         ...
         <tr class="medication_info_th1" width="100%">
         <td colspan="2"  height="30px"  align="left">
             &nbsp;&nbsp;Insurance Details [Edit Mode]</td><td align="right">
            <asp:ImageButton ID="btnInsEditClose" runat="server"  ImageUrl="../images/close_popup.png" Height="16px" Width="16px" border="0" ToolTip="Close"></asp:ImageButton>
                ...
                <table align="center" class="medication_info_popup" cellpadding="0" cellspacing="1">
                <tr >
                <td align="left"><asp:Label ID = "Label25" Text = "Insurance Name :" runat = "server"   Font-Bold="True"></asp:Label></td>
                <td colspan="2"><asp:TextBox ID="txtEditInsName" runat="server"></asp:TextBox></td></tr>
                <tr>
                <td>
                <asp:Label ID = "Label29" Text = "Insurance Phone :" runat = "server"  Font-Bold="True"></asp:Label>
                </td>
                <td colspan="2"><asp:TextBox ID="txtEditInsPhone" runat="server"></asp:TextBox></td></tr>
                <tr><td align="left" >
                <asp:Label ID = "Label30" Text = "Policy ID :" runat = "server"  Font-Bold="True"></asp:Label>
                </td><td align="left" colspan="2">
                <asp:TextBox ID="txtEditInsPolicyID" runat="server" ></asp:TextBox></td></tr>
                <tr><td align="left" >
                ...
                <asp:TextBox ID="txtEditInsBinNo" runat="server" ></asp:TextBox></td></tr><tr><td align="left" >
                <asp:Label ID = "Label33" Text = "Insured Name :" runat = "server" Font-Bold="True"></asp:Label></td>
                <td align="left" colspan="2">
                <asp:TextBox ID="txtEditInsdName" runat="server" ></asp:TextBox></td></tr><tr><td align="left">
                ...
                <cc1:CalendarExtender ID="CalendarExtender1" 
                                  ...
                                  <td align="left" colspan="2"><asp:TextBox ID="txtEditInsSSN" runat="server" ></asp:TextBox></td>
                                  </tr><tr><td align="left" >
                                  <asp:Label ID = "Label36" Text = "Insured Relation :" runat = "server"  Font-Bold="True"></asp:Label>
                                  </td><td align="left" colspan="2"><asp:TextBox ID="txtEditInsRelation" runat="server" ></asp:TextBox></td></tr><tr><td align="left" colspan="3"><asp:Label ID="Label37" runat = "server" Text = "Is Primary Insurance:" 
                                  Font-Bold="True" ></asp:Label>
             ...
             <asp:ImageButton ID="btnEditInsurance" runat="server"  ImageUrl="../images/save.gif" border="0" 
                                              onclick="btnEditInsurance_Click"></asp:ImageButton></td></tr></table></td></tr></table>
    </asp:Panel>                                    
                                         
    </ContentTemplate>
</cc1:TabPanel>
<cc1:TabPanel ID="Pat_Rx_Notes" runat="server" Height="85"><HeaderTemplate>
                Comments
...
<cc1:ModalPopupExtender ID="AddNote" runat="server" TargetControlID="btnAddNote" 
                      ...
                      BackgroundCssClass="modalBackground" DynamicServicePath="" Enabled="True"></cc1:ModalPopupExtender>
                <asp:GridView ID="gridNotes" runat="server" AutoGenerateColumns="False" 
                     ...
                     ><AlternatingRowStyle CssClass="medication_info_tr-even" /><Columns>
                       <asp:TemplateField   ShowHeader="False">
    <EditItemTemplate>
    ...
    <asp:LinkButton ID="lnkCancelNotes" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel"></asp:LinkButton>
                        </EditItemTemplate><ItemTemplate><asp:LinkButton ID="lnkEditNotes" runat="server" CausesValidation="False" CommandName="Edit"><asp:Image ID="imgEditNotes" runat="server" ImageUrl="../Images/edit.gif" ToolTip="Edit"/></asp:LinkButton></ItemTemplate><HeaderStyle CssClass="patient_cm_info_th1" /><ItemStyle HorizontalAlign="Center" width="20px"/></asp:TemplateField><asp:TemplateField><ItemTemplate><asp:LinkButton ID="lnkDeleteNotes" runat="server" CausesValidation="False" CommandName="Delete"   OnClientClick="if(!confirm('Do you want to delete Comments?')){ return false;}"><asp:Image ID="imgDeleteNotes" runat="server" ImageUrl="../Images/delete.gif" ToolTip="Delete"/></asp:LinkButton></ItemTemplate><ItemStyle HorizontalAlign="Center" Width="20px" /></asp:TemplateField>
                      ...
                      <asp:TemplateField HeaderText="Comment"><EditItemTemplate><asp:TextBox ID="txtNoteDesc" runat="server" 
                                        Text='<%# Eval("Note_Description")%>' Width="250px"></asp:TextBox></EditItemTemplate><ItemTemplate><asp:Label ID="lblNoteDesc" runat="server" 
                                        Text='<%# Eval("Note_Description") %>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField><asp:TemplateField HeaderText="Date/Time"><ItemTemplate><asp:Label ID="lblNoteDate" runat="server" 
                                        Text='<%# Eval("Note_Date") %>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Center" Width="200px" /></asp:TemplateField><asp:TemplateField HeaderText="User"><ItemTemplate><asp:Label ID="lblNoteBy" runat="server" 
                                        Text='<%# Eval("Note_by") %>'></asp:Label></ItemTemplate><ItemStyle HorizontalAlign="Left" Width="200px" /></asp:TemplateField>
                                             </Columns><HeaderStyle CssClass="medication_info_th1" /><RowStyle CssClass="medication_info_tr-odd" /></asp:GridView><asp:LinkButton ID="btnAddNote" runat="server" OnClientClick="clearNotePanel();" ForeColor="#000066" >Add Comment</asp:LinkButton><asp:Panel ID="pnlAddNote" runat="server" BorderColor="Black" BorderWidth="1px"  BackColor="#FBFBFB" ><table width="350"   border="0" cellpadding="0" cellspacing="0"><tr class="medication_info_th1" width="100%"><td colspan="2"  height="30px"  align="left">
                    &nbsp;&nbsp;Note </td><td align="right"><asp:ImageButton ID="btnNClose" runat="server"  ImageUrl="../images/close_popup.png" Height="16px" Width="16px" border="0" ToolTip="Close"></asp:ImageButton>
                        &nbsp;</td></tr><tr><td width="350" colspan="3" align="center"><table align="center" class="medication_info_popup" cellpadding="0" cellspacing="1" width="100%"><tr width="100%"><td align="left" ><asp:Label ID = "Label2" Text = "Note :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="right" height="25px" colspan="2" width="100%"><asp:TextBox ID="txtNoteDesc" runat="server" TextMode="MultiLine" Rows="5" Width="80%"></asp:TextBox></td></tr><tr><td  align="center" colspan="4"><asp:ImageButton ID="btnSaveNote" runat="server"  ImageUrl="../images/save.gif" border="0" OnClick="btnSaveNote_Click" OnClientClick="return ValidatePatientNote();"></asp:ImageButton></td></tr></table></td></tr></table></asp:Panel>
...
<Columns>
    ...
    <ItemTemplate>
        ...
        <asp:Image ID="imgEditCallLog" runat="server" ImageUrl="../Images/edit.gif" ToolTip="Edit"/></asp:LinkButton>
    </ItemTemplate>
    <HeaderStyle CssClass="patient_cm_info_th1" />
    <ItemStyle HorizontalAlign="Center" width="20px"/>
    ...
    <ItemTemplate><asp:Label ID="lblDate" runat="server" Text='<%# Eval("Call_Time") %>'></asp:Label>
    ...
    <ItemTemplate><asp:Label ID="lblCsrName" runat="server" Text='<%# Eval("CSR_Name")%>'></asp:Label>                                
    </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="80px" />
    </asp:TemplateField><asp:TemplateField HeaderText="Note">
    <ItemTemplate>
    ...
    </asp:TemplateField><asp:TemplateField HeaderText="Issue For">
    <ItemTemplate><asp:Label ID="lblCallIssueFor" runat="server" Text='<%# Eval("IssueFor")%>'></asp:Label>                                
    </ItemTemplate>
    <ItemStyle HorizontalAlign="Left" />
    </asp:TemplateField>
...
<cc1:ModalPopupExtender ID="ModalPopuAddShipLogs" runat="server" 
                        ...
                        OnRowDataBound ="gridPayments_RowDataBound"
                             ...
                             AllowPaging="True"><AlternatingRowStyle CssClass="medication_info_tr-even" /><Columns>
                                                       <asp:TemplateField   ShowHeader="False">
    <EditItemTemplate>
    ...
    <ItemTemplate>
    <asp:ImageButton ID="ImageButton1" runat="server"  ImageUrl="~/images/delete.gif" OnClientClick="if(!confirm('Do you want to delete Call Log')){ return false;}" CommandName="Delete" CommandArgument='<%# Eval("Payment_ID") %>'/></ItemTemplate>
    <ItemStyle HorizontalAlign="Center" Width="20px" /></asp:TemplateField>
    <asp:TemplateField Visible="False">
    <ItemTemplate><asp:Label ID="lblPayID" runat="server" Text='<%# Eval("Payment_ID") %>'>
    </asp:Label>
                                                 </ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Payment Type"><ItemTemplate><asp:Label ID="lblDate" runat="server" Text='<%# Eval("Payment_Mode") %>'></asp:Label>
                                                 </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="100px" /></asp:TemplateField><asp:TemplateField HeaderText="Pay Date"><ItemTemplate><asp:Label ID="lblPayDate" runat="server" Text='<%# Eval("Payment_Date")%>'></asp:Label>                                
                                                 </ItemTemplate><ItemStyle Width="200px" /></asp:TemplateField><asp:TemplateField HeaderText="Amount"><ItemTemplate><asp:Label ID="lblPayAmount" runat="server" Text='<%# Eval("Payment_Amount")%>' ></asp:Label>                                
                                                 </ItemTemplate><EditItemTemplate><asp:TextBox ID="txtPayAmount" runat="server" 
                                        Text='<%# Eval("Payment_Amount")%>'></asp:TextBox></EditItemTemplate><ItemStyle HorizontalAlign="Right" Width="100px" /></asp:TemplateField><asp:TemplateField HeaderText="Description"><ItemTemplate><asp:Label ID="lblPayDesc" runat="server" Text='<%# Eval("Payment_Notes")%>'></asp:Label>                                
                                                 </ItemTemplate><EditItemTemplate><asp:TextBox ID="txtPayDesc" runat="server" 
                                        Text='<%# Eval("Payment_Notes")%>'></asp:TextBox></EditItemTemplate><ItemStyle HorizontalAlign="Left" /></asp:TemplateField>
                                        <asp:TemplateField HeaderText="Check/CC#">
                                        <ItemTemplate><asp:Label ID="lblChequeorCC" runat="server" Text='<%# Eval("Check_OR_CC_Number")%>'></asp:Label>
                                         </ItemTemplate>
                                         <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="R/P">
                                        <ItemTemplate><asp:Label ID="lblPatPaymentSysLoc" runat="server" Text='<%# Eval("Payment_SysFlag")%>'></asp:Label>
                                         </ItemTemplate>
                                        
                                         <ItemStyle HorizontalAlign="Center" Width="40px" /></asp:TemplateField>
                                             </Columns><HeaderStyle CssClass="medication_info_th1" /><RowStyle CssClass="medication_info_tr-odd" /></asp:GridView>
                                             <asp:LinkButton ID="btnAddPayments" runat="server" OnClientClick="return clearPaymentsPanel();" ForeColor="#000066">Add Payment</asp:LinkButton><asp:Panel ID="pnlAddPayments" runat="server" BorderColor="Black" BorderWidth="1px"  BackColor="#FBFBFB" ><table width="400"   border="0" cellpadding="0" cellspacing="0"><tr class="medication_info_th1" width="100%"><td colspan="2"  height="30px" align="left" >
                                                     &nbsp;&nbsp;Payment Information </td><td align="right"><asp:ImageButton ID="btnPayCancel" runat="server" ImageUrl="../images/close_popup.png" Height="16px" Width="16px" border="0" ToolTip="Close"></asp:ImageButton>
                                                         &nbsp;</td></tr><tr><td width="400" colspan="3" align="center"><table align="center" class="medication_info_popup" cellpadding="0" cellspacing="1" width="100%"><tr width="100%"><td align="left" width="30%" ><asp:Label ID = "lblPatAccount" Text = "Patient Account :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left"  colspan="2" width="70%"><asp:Label ID="lblPatAccountName" runat="server" ></asp:Label></td></tr><tr width="100%"><td align="left" ><asp:Label ID = "lblPayMode" Text = "Mode of Payment :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left"  colspan="2">
                                  ...
                                  <asp:RadioButton ID="rbtnPayCash" Text="Cash" GroupName="PayMode" runat="server" Checked="True" 
                                                             ...
                                                             </td></tr><tr width="100%"><td align="left" ><asp:Label ID = "lblChequeorCC" Text = "Check No/CC# :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td>
                                  <td align="left"  colspan="2" >
                                  ...
                                  <tr width="100%">
                                  <td align="left" ><asp:Label ID = "lblCCAuth" Text = "Payment Auth# :" runat = "server"  Font-Bold="True"></asp:Label></td><td align="left"  colspan="2" ><asp:TextBox ID="txtCCAuth"  
                                                                 runat="server" TabIndex="4" ></asp:TextBox><asp:Label ID="lblCCAuth1" runat="server" Text="for CC payments"></asp:Label></td></tr><tr width="100%"><td align="left" ><asp:Label ID = "lblPayAmount" Text = "Payment Amount :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left"  colspan="2" ><asp:TextBox ID="txtPayAmount"  
                                                                 runat="server" TabIndex="5" ></asp:TextBox></td></tr><tr width="100%"><td align="left" ><asp:Label ID = "lblPatientContact" Text = "Patient Contact :" 
                                  runat = "server"  Font-Bold="True"></asp:Label></td><td align="left"  colspan="2" ><asp:Label ID="lblPatientContact1" runat="server" ></asp:Label>
                                                             <asp:TextBox ID="TextBox4"  runat="server" Visible="False" TabIndex="6"></asp:TextBox></td></tr><tr width="100%"><td align="left" ><asp:Label ID = "lblPaymentNote" Text = "Description :" runat = "server"  
                                  Font-Bold="True"></asp:Label></td><td align="left"  colspan="2" ><asp:TextBox ID="txtPaymentNote" 
                                                                 Width="80%" runat="server" Rows="5" TextMode="MultiLine" TabIndex="7"></asp:TextBox></td></tr><tr><td  align="center" colspan="4">
                                                         <asp:ImageButton ID="btnSavePayment" runat="server"  
                                                             ImageUrl="../images/save.gif" border="0" OnClick="btnSavePayment_Click" 
                                                             OnClientClick="return ValidatePatientPayments();" TabIndex="8"></asp:ImageButton></td></tr></table></td></tr></table></asp:Panel>
...
<cc1:TabPanel ID="Shipping_Log" runat="server" Height="85"><HeaderTemplate>
      Shipping Log
    </HeaderTemplate>
<ContentTemplate>
...
<Columns>
<asp:TemplateField><ItemTemplate>
<asp:ImageButton ID="ImageButton1" runat="server"  ImageUrl="~/images/delete.gif" OnClientClick="if(!confirm('Do you want to delete Document')){ return false;}" CommandName="Delete" CommandArgument='<%# Eval("Pat_Doc_ID") %>'/></ItemTemplate>
<ItemStyle HorizontalAlign="Center" Width="20px" />
</asp:TemplateField>
<asp:TemplateField>
<ItemTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="20px"/></asp:TemplateField>
...
<ItemTemplate><asp:Label ID="lblDocName" runat="server" Text='<%# Eval("Doc_Name") %>'></asp:Label></ItemTemplate>
<ItemStyle HorizontalAlign="Left" Width="150px"/>
</asp:TemplateField><asp:TemplateField HeaderText="Description">
<ItemTemplate>
<asp:Label ID="lblDocDesc" runat="server" Text='<%# Eval("Doc_Desc") %>'></asp:Label></ItemTemplate>
<ItemStyle HorizontalAlign="Left" /></asp:TemplateField>
</Columns>
<AlternatingRowStyle CssClass="medication_info_tr-even" />
<HeaderStyle CssClass="medication_info_th1" />
<RowStyle CssClass="medication_info_tr-odd" /></asp:GridView>
...
<asp:TextBox ID="txtDocuName" runat="server"></asp:TextBox></td></tr>
<tr >
<td align="left">
...
<tr>
<td  align="center" colspan="4">
<asp:ImageButton ID="btnSaveDoc" runat="server"  ImageUrl="../images/save.gif" border="0" OnClick="btnSaveDoc_Click" OnClientClick="return ValidatePatientDocument();"></asp:ImageButton></td></tr></table></td></tr></table>
 </ContentTemplate>
<Triggers>
...
<asp:TemplateField>
<ItemTemplate>
<asp:ImageButton ID="imgBtnDeleteBill" runat="server"  ImageUrl="~/images/delete.gif" OnClientClick="if(!confirm('Do you want to delete Bill')){ return false;}" CommandName="Delete" CommandArgument='<%# Eval("Trans_No") %>'/></ItemTemplate>
<ItemStyle HorizontalAlign="Center" Width="20px" />
</asp:TemplateField>
