<%@ Page Language="C#" MasterPageFile="~/Templates/eCareXMaster.master" AutoEventWireup="true" CodeFile="PharmacistHome.aspx.cs" Inherits="PharmacistHome" Title="eCarex Health Care System" %>
...
<table width="100%">
        ...
        <tr class="medication_info_th1">
            <td align="left"  colspan="12" style="height:25px;vertical-align:middle;">
        ...
        <tr>
            ...
            <td>
                    <asp:LinkButton runat="server" onclick="btnPrint_Click" ID="btnPrint" ><asp:Image ID="imgPrint1" runat="server" ToolTip="Print" ImageUrl="../Images/print.gif" /></asp:LinkButton>
            </td>
            <td>    
                    <asp:LinkButton runat="server" onclick="btnPrint_Click" ID="btnAdminPrint" ><asp:Image ID="Image2" runat="server" ImageUrl="../Images/print.gif" ToolTip="Admin Print" /></asp:LinkButton>
            </td>
        </tr>
        <tr class="medication_info_tr-odd">
